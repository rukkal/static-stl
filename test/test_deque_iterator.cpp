...
struct fixture_deque_iterator
{
  sstl::deque<value_type, 11> d = make_noncontiguous_deque<value_type>({0, 1, 2, 3, 4, 5, 6}); 
};

TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - default constructor")
{
   iterator_type nonconst_it;
   const_iterator_type const_it;
}

TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - non-const iterator to const iterator conversion")
{
   iterator_type nonconst_it;
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - non-const iterator and const iterator comparison")
{
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - expressions required by InputIterator concept")
{
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - expressions required by ForwardIterator concept")
{
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - expressions required by BidirectionalIterator concept")
{
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - expressions required by RandomAccessIterator concept")
{
...
TEST_CASE_METHOD(fixture_deque_iterator, "deque_iterator - expressions required by OutputIterator concept")
{
   SECTION("*o = value")
   {
      iterator_type it = d.begin();
